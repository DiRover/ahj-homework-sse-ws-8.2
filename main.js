...
// Module
var code = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"UTF-8\"> <meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"> <title>Task_8.2</title> </head> <div class=\"modal\"> <h2 class=\"modal-title\">Enter your nickname</h2> <p class=\"tip tip-nickname\">Enter your nickname!</p> <form class=\"add-form\" id=\"add-form\" novalidate> <div class=\"form-field\"> <input type=\"text\" id=\"form-input\" class=\"form-input\" required> </div> </form> <button form=\"add-form\" class=\"form-button\">Continue!</button> </div> <div class=\"container\"> <div class=\"chat-box\"></div> <div class=\"msg-box\"> <div class=\"chat-field\"> <form class=\"chat-form\" id=\"chat-form\" novalidate> <input type=\"text\" id=\"chat-input\" class=\"chat-input\" placeholder=\"Enter text\" required> </form> <button form=\"chat-form\" class=\"chat-button material-icons\">send</button> </div> <p class=\"tip-msg\">Message field is empity or you doesn't enter your nickname!</p> </div> <div class=\"users-list\"> <ul class=\"list\"></ul> </div> </div> <div class=\"test\">test</div> <table> <tr><td>row 1</td></tr> <tr><td>row 2</td></tr> </table> <div>Icons made by <a href=\"https://www.flaticon.com/authors/freepik\" title=\"Freepik\">Freepik</a> from <a href=\"https://www.flaticon.com/\" title=\"Flaticon\">www.flaticon.com</a></div>  </html>";
// Exports
module.exports = code;
...
var API = /*#__PURE__*/function () {
  ...
  _createClass(API, [{
    ...
    key: "getRequest",
    value: function getRequest(type, nickname, text) {
    ...
    value: function responseHandler(e) {
      ...
      if (this.type === 'error') {
        ...
        //список юзеров
        this.serverResponse = this.response.users.map(function (user) {
          if (user === _this.userNickname) {
            //переписываем на You текущее имя юзера в списке
            return user = _this.currentName;
          } else {
    ...
    value: function getDate() {
      //получаем текущею дату сообщения
      var date = new Date();
      ...
      var now = hour + '.' + minutes + ' ' + day + '.' + month + '.' + year;
      return now;
    }
  }, {
    key: "nicknameValid",
    value: function nicknameValid(e) {
      //обрабатываем оригинальный никнэйм и записываем его
    ...
    key: "userMessage",
    value: function userMessage(nickname) {
      //стилизуем сообшения
...
var inputChat = document.querySelector('.chat-input');
var charBox = document.querySelector('.chat-box');
var tipNickname = document.querySelector('.tip-nickname');
var tipMsg = document.querySelector('.tip-msg');
var url = 'wss://websocket-serv.herokuapp.com/ws'; ////const url = 'wss://localhost:7070/ws';

var api = new API(url);
var ws = api.getWebSocket();
addForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var target = e.currentTarget.checkValidity();
...
ws.addEventListener('message', function (e) {
  ...
  if (api.type === 'user added') {
    usersList.innerHTML = '';
    api.serverResponse.forEach(function (user) {
      //отрисовываем список юзеров и меняем имя текущего пользователя на You
      var el = document.createElement('li');
      el.innerHTML = user === 'You' ? "<span>".concat(user, "<span>") : "".concat(user);
      usersList.append(el);
    });
    ...
    //отрисовываем сообщения в чате
    var el = document.createElement('div');
    var userNickname = api.userMessage(api.serverResponse.name);
    api.userMessage(api.serverResponse.name);
    el.innerHTML = "\n    <h4 class=".concat(api.userTitleStyle, ">").concat(userNickname, " ").concat(api.getDate(), "</h4>\n    <p>").concat(api.serverResponse.text, "</p>");
    el.setAttribute('class', api.userMessageStyle);
    charBox.append(el);
  }
});
window.addEventListener('beforeunload', function () {
  //load при F5 не работает в Firefox
...
var src = __webpack_require__(7766);
